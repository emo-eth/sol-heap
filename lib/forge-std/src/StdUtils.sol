...
abstract contract StdUtils {
    ...
    /// @notice adapated from Solmate implementation
        ...
        returns (address)
    {
        ...
        // More details about RLP encoding can be found here:
        // https://eth.wiki/fundamentals/rlp
        // 0xda = 0xc0 (short RLP prefix) + 0x16 (length of: 0x94 ++ proxy ++
        // 0x84 ++ nonce)
        ...
        returns (uint256)
    {
        ...
        return
            abi.decode(abi.encodePacked(new bytes(32 - b.length), b), (uint256));
    }
